    ...
    function show_current_page() {
      ...
      if (trial.show_clickable_nav) {
        ...
        if (trial.force_wait !== null) {
          ...
          display_element.querySelector('#jspsych-instructions-next').setAttribute("disabled", "disabled")  //.style.visibility = 'hidden';
          jsPsych.pluginAPI.setTimeout(function() {
	    display_element.querySelector('#jspsych-instructions-next').removeAttribute('disabled')    //.style.visibility = 'visible';
          }, trial.force_wait);
        }
      } else {
